...
class ChatResponse(BaseModel):
    ...
    needs_clarification: bool = Field(..., description="True if query is too ambiguous and needs clarification.")
    missing_information: List[str] = Field(..., description="List of missing diagnostic or context information.")
    data_status: str = Field(..., description="Status of the retrieved data. Must be one of: live|verified|cached|general|estimated|unavailable")
